...
### FINAL Inflammation and Surgery
...
final_venn <- ggVennDiagram(x = inf_surg_list_full, fill= "red") # color
final_venn
ggsave("venn_inf_surg.png", inf_surg_venn) 
